...
from tensorflow_datasets.vision_language.laion.laion400m_dataset_builder_utils import get_example_metadata
...
def _get_paths(file_name_to_dl_path: Dict[str, epath.Path],
...
class Laion400mEmb(Laion400mDatasetBuilder):
  ...
  def _generate_examples_one_shard(self,
    ...
    img_emb_path, text_emb_path, metadata_path = _get_paths(
        file_name_to_dl_path, shard_idx)

    with img_emb_path.open('rb') as f:
