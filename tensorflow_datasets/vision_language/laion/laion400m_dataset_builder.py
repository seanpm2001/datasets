...
from tensorflow_datasets.vision_language.laion.laion400m_dataset_builder_utils import LAION400M_HOMEPAGE
...
class Laion400mDatasetBuilder(
  ...
  It provides functionality to ease the processing of Laion datasets.
  ...
  def create_dataset_info(
    ...
    """Creates the dataset metadata and adds common features."""
